...
export function Compose() {
    ...
    const [business_roles, setBusinessRoles] = useState([]);
    ...
    useEffect(() => {
        if (data.roles) {
            ...
            setBusinessRoles(data.business_roles)
            setTypes(data.types)
        }
    }, [data]);
                            ...
                            <form id="kt_inbox_compose_form" onReset={()=>setResetForm(!resetForm)} onSubmit={sendMail}>
                                ...
                                <div className="d-block">
                                    ...
                                    <SummernoteField  field={{
                                        ...
                                        value={tempVal.message} onChange={onChange} touched={tempTouched.message}/>
                                    {/*end::Message*/}
