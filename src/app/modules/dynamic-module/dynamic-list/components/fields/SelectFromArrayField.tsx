...
const SelectFromArrayField = ({field, onChange, value, touched, error }:Props) => {
        ...
        >
            {
                Object.entries(field.options).map(( key:any, value:any) => {
                    return (<option value={getValue(value, 'key')} key={field.name+'_'+getValue(value, 'key')+'_'+key}>
