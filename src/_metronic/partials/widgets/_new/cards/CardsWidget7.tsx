...
const items: Array<{
  ...
  {name: 'Michael Eberon', src: toAbsoluteUrl('assets/media/avatars/300-11.jpg')},
  {name: 'Susan Redwood', initials: 'S', state: 'primary'},
  {name: 'Melody Macy', src: toAbsoluteUrl('assets/media/avatars/300-2.jpg')},
  {name: 'Perry Matthew', initials: 'P', state: 'danger'},
  {name: 'Barry Walter', src: toAbsoluteUrl('assets/media/avatars/300-12.jpg')},
]
