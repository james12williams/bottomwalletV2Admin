        ...
        <div className='mb-5 pe-3'>
          ...
          <div className='d-flex align-items-center mt-1 fs-6'>
            ...
            <div
              ...
              title='Jan Hummer'
            >
              <img src={toAbsoluteUrl('assets/media/avatars/300-23.jpg')} alt='img' />
            </div>
          </div>
        </div>
        ...
        <div className='overflow-auto pb-5'>
          <div className='d-flex align-items-center border border-dashed border-gray-300 rounded min-w-700px p-5'>
            <div className='d-flex flex-aligns-center pe-10 pe-lg-20'>
              <img alt='' className='w-30px me-3' src={toAbsoluteUrl('assets/media/svg/files/pdf.svg')} />
            ...
            <div className='d-flex flex-aligns-center pe-10 pe-lg-20'>
              <img alt='' className='w-30px me-3' src={toAbsoluteUrl('assets/media/svg/files/doc.svg')} />
            ...
            <div className='d-flex flex-aligns-center'>
              <img alt='' className='w-30px me-3' src={toAbsoluteUrl('assets/media/svg/files/css.svg')} />
