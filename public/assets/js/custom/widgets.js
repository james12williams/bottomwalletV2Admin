...
var KTWidgets = function () {
    ...
    const createRepeater = function (){
        const elements = [].slice.call(document.querySelectorAll('[data-control="repeater"], [data-kt-repeater="true"]'));
        ...
        elements.forEach(function (element) {
            ...
            $('#'+elementId)
                ...
                show: function () {
                    $(this).slideDown();
                    setTimeout(() => {
                        const allConditionTypeList = document.querySelectorAll('[name^="'+elementId+'"]');
                        allConditionTypeList.forEach(allConditionType=>{
                            if ($(allConditionType).hasClass("select2-hidden-accessible")) {
                                if (allConditionType.getAttribute("data-kt-hidden-initialized") === "1") {
                                    return;
                                }
                                $(allConditionType).select2({
                                    minimumResultsForSearch: -1
                                });
                                allConditionType.setAttribute("data-kt-hidden-initialized", "1");
                            }
                        })
                    });
                },
...
if (typeof module !== 'undefined' && typeof module.exports !== 'undefined') {
    window.KTWidgets = module.exports = KTWidgets;
}
